...
public class Client {
    ...
    private static JComboBox<String> openPortsComboBox; // To display open ports
    private static JTextField selectedIPAddressField; // To display selected IP address from openPortsComboBox
